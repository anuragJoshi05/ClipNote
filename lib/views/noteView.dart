import 'package:clipnote/views/backgroundSwitcher.dart';
import 'package:clipnote/services/firestore_db.dart';
import 'package:clipnote/services/ai_service.dart'; // Add this import
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:clipnote/views/home.dart';
import 'package:clipnote/views/editNoteView.dart';
...
class _NoteViewState extends State<NoteView>
  ...
  bool _isGeneratingSummary = false; // Add this
  String? _backgroundImage;
  String? _currentSummary; // Add this
  ...
  void initState() {
    ...
    _currentSummary = _note.summary; // Initialize summary
  }
  ...
  Future<void> _generateAISummary() async {
    if (_isGeneratingSummary || _note.content.trim().isEmpty) return;
    ...
    try {
      ...
      await _saveSummaryToDatabase(summary);

      _showSnackBar('AI summary generated successfully!', Icons.auto_awesome);
      ...
      _showErrorSnackBar('Failed to generate summary: ${e.toString()}');
    }
  }
  ...
  Future<void> _saveSummaryToDatabase(String summary) async {
    try {
      final updatedNote = _note.copy(summary: summary);
      ...
      // Silent fail for summary save - main functionality still works
      debugPrint('Failed to save summary to database: $e');
    }
  }
                    ...
                    ScaleTransition(
                      ...
                      child: FadeTransition(
                        ...
                        child: _buildActionButton(
                          icon: _note.isArchieve
                              ? Icons.star
                              : Icons.star_outlined,
                          onPressed: _updateNoteArchiveStatus,
                          color: _note.isArchieve
                              ? Colors.amber[400]!
                              : Colors.white,
                        ),
                      ),
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(
                        horizontal:
                            isLandscape ? size.width * 0.08 : size.width * 0.05,
                        vertical: 16,
                      ),
                      child: Scrollbar(
                        ...
                        child: SingleChildScrollView(
                          ...
                          padding: EdgeInsets.only(
                            bottom: 180, // Space for FABs and AI button
            ...
            if (_note.content.trim().isNotEmpty)
              _buildFAB(
                ...
                backgroundColor: _isGeneratingSummary
                    ? Colors.grey[600]!
                    : Colors.purple[600]!,
                onPressed: _isGeneratingSummary ? () {} : _generateAISummary,
                tooltip: _currentSummary != null
  ...
  String _getTooltipForIcon(IconData icon) {
    ...
    if (icon == Icons.star || icon == Icons.star_outlined)
      return 'Archive Note';
